...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ImgButton_t, stringdata) + ofs \
...
const QMetaObject ImgButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_ImgButton.data,
      qt_meta_data_ImgButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ImgButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImgButton.stringdata))
