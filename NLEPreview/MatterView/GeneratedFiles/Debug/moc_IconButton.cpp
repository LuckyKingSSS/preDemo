...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_IconButton_t, stringdata) + ofs \
...
const QMetaObject IconButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_IconButton.data,
      qt_meta_data_IconButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *IconButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_IconButton.stringdata))
