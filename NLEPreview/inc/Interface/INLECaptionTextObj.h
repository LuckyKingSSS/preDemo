...
public:
	...
	*@return
	*/
	virtual bool __stdcall SetLineSpace(int nLineSpace) = 0;
	/**
	*@brief     获取行距
	*@param  nLineSpace 行距
	*@return
	*/
	virtual bool __stdcall GetLineSpace(int* pnLineSpace) = 0;
	/**
	*@brief     设置字距
	*@param  nCharSpace 字距
	*@return
	*/
	virtual bool __stdcall SetCharSpace(int nCharSpace) = 0;
	/**
	*@brief     获取字距
	*@param  pnCharSpace 字距
	*@return
	*/
	virtual bool __stdcall GetCharSpace(int* pnCharSpace) = 0;
	/**
	*@brief     设置文字对其模式
