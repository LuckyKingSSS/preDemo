    ...
    */
	...
	{	
		extern LPCWCHAR NLE_KEY_API
			...
			///渲染的掩码文件{与渲染区域配合使用}
			kRender_MaskFile, // 蒙版文件路径。std::wstring。
	...
	{
		extern NLE_CHAR NLE_KEY_API
			kCaption_Text_Section_Count, 
			kCaption_Text_Title,
			kCaption_Text_Font_Size,
			kCaption_Text_Font_Bold,
			kCaption_Text_Font_Italic,
			kCaption_Text_Font_FontName,

			kCaption_Text_Face_Enable,
			kCaption_Text_Face_Color1,
			kCaption_Text_Face_Color2,
			kCaption_Text_Face_GradType,
			kCaption_Text_Face_Alpha,
			kCaption_Text_Face_BlurRadius,
			kCaption_Text_Face_Effect,

			kCaption_Text_Shadow_Enable,
			kCaption_Text_Shadow_Color,
			kCaption_Text_Shadow_Alpha,
			kCaption_Text_Shadow_BlurRadius,
			kCaption_Text_Shadow_Distance,
			kCaption_Text_Shadow_Direction,

			kCaption_Text_Border_Enable,
			kCaption_Text_Border_Size,
			kCaption_Text_Border_Color1,
			kCaption_Text_Border_Color2,
			kCaption_Text_Border_GradType,
			kCaption_Text_Border_Alpha,
			kCaption_Text_Border_BlurRadius,
			kCaption_Text_RowSpace,
			kCaption_Text_LineSpace;
	}
	namespace Motion
	{
		extern NLE_CHAR NLE_KEY_API
