...
#else
#define  KEY_DEFINE_VK_RETURN   10      //Big Enter
#define  KEY_DEFINE_VK_LINEFEED 13
...
#define  KEY_DEFINE_VK_TAB 48 
#define  KEY_DEFINE_VK_DELETE 46
#define  KEY_DEFINE_VK_SPACE   49
//    #define  KEY_DEFINE_VK_RETURN  36
#endif


#define  NLE_DEFAULT_DRAG_WIDTH  9
...
{
	int				IsEnable;				// 1-Enable, 0-Disable
	wchar_t			wszFilePath[256];		// Texture Image Path

	NLETexture()
	{
		IsEnable = 0;
		memset(wszFilePath, 0, sizeof(wchar_t)* 256);
	}
